...
template <> constexpr inline auto Enemy::qt_create_metaobjectdata<qt_meta_tag_ZN5EnemyE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'shootBullet'
        QtMocHelpers::SignalData<void(QPointF, qreal)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
...
void Enemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->shootBullet((*reinterpret_cast<std::add_pointer_t<QPointF>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<qreal>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Enemy::*)()>(_a, &Enemy::destroyed, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Enemy::*)(QPointF , qreal )>(_a, &Enemy::shootBullet, 1))
            return;
    }
}
...
// SIGNAL 1
void Enemy::shootBullet(QPointF _t1, qreal _t2)
{
